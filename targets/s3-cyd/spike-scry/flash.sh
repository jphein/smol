...
readonly ALLOW_SERIAL="14:C1:9F:D1:CC:64"   # smol node id 163 — the scry station. Byte-exact only — see above.
...
readonly DENY_SERIALS=(
    ...
    "14:C1:9F:D1:C8:10"   # s3-cyd dev board (node 162) — the spike's lane, not ours.
